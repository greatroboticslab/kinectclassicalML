...
from kinect_learning_time_it import (joints_collection, load_data, SVM, Random_Forest, AdaBoost, Gaussian_NB, Knn, Neural_Network)
import time
## Build path to file.
DATA_DIR = 'data'
...
print("SVM with noise data Duration:", SVM(X, y, test_size, 'linear'))
